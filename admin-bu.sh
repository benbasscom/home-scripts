...
SOURCE="/Volumes/Storage/Share Points/Admin/"
DESTINATION="/Shared Items/Admin-bu"
LOG="/Library/Logs/com.trmacs/admin-bu.log"
EXCLUDES="/Users/admin/Documents/rsync-excludes.txt"
BACKUPDIR=$2
: ${BACKUPDIR:="/Shared Items/Versions/Admin/$UNIQUE"}
...
echo "----------------------------------"		>> "${LOG}"
echo "   Admin BU + Versions Backup"			>> "${LOG}"
echo "----------------------------------"		>> "${LOG}"
echo ""							>> "${LOG}"
date							>> "${LOG}"
echo ""							>> "${LOG}"
