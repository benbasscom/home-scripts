...
SOURCE="/Volumes/Storage/webroot/"
DESTINATION="/Shared Items/webroot-bu/"
LOG="/Library/Logs/com.trmacs/webroot-bu.log"
EXCLUDES="/Users/admin/Documents/rsync-excludes.txt"
BACKUPDIR=$2
: ${BACKUPDIR:="/Shared Items/Versions/webroot/$UNIQUE"}
