...
SOURCE="/Volumes/Storage/Share Points/Documents/"
DESTINATION="/Shared Items/Documents-bu"
LOG="/Library/Logs/com.trmacs/doc-bu.log"
EXCLUDES="/Users/admin/Documents/rsync-excludes.txt"
BACKUPDIR=$2
: ${BACKUPDIR:="/Shared Items/Versions/Documents/$UNIQUE"}
